!function(e,t,n,a,r,i,o,d){var s="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},l="function"==typeof s[a]&&s[a],p=l.i||{},c=l.cache||{},g="undefined"!=typeof module&&"function"==typeof module.require&&module.require.bind(module);function x(t,n){if(!c[t]){if(!e[t]){if(r[t])return r[t];var i="function"==typeof s[a]&&s[a];if(!n&&i)return i(t,!0);if(l)return l(t,!0);if(g&&"string"==typeof t)return g(t);var o=Error("Cannot find module '"+t+"'");throw o.code="MODULE_NOT_FOUND",o}p.resolve=function(n){var a=e[t][1][n];return null!=a?a:n},p.cache={};var d=c[t]=new x.Module(t);e[t][0].call(d.exports,p,d,d.exports,s)}return c[t].exports;function p(e){var t=p.resolve(e);if(!1===t)return{};if(Array.isArray(t)){var n={__esModule:!0};return t.forEach(function(e){var t=e[0],a=e[1],r=e[2]||e[0],i=x(a);"*"===t?Object.keys(i).forEach(function(e){"default"===e||"__esModule"===e||Object.prototype.hasOwnProperty.call(n,e)||Object.defineProperty(n,e,{enumerable:!0,get:function(){return i[e]}})}):"*"===r?Object.defineProperty(n,t,{enumerable:!0,value:i}):Object.defineProperty(n,t,{enumerable:!0,get:function(){return"default"===r?i.__esModule?i.default:i:i[r]}})}),n}return x(t)}}x.isParcelRequire=!0,x.Module=function(e){this.id=e,this.bundle=x,this.require=g,this.exports={}},x.modules=e,x.cache=c,x.parent=l,x.distDir=void 0,x.publicUrl=void 0,x.devServer=void 0,x.i=p,x.register=function(t,n){e[t]=[function(e,t){t.exports=n},{}]},Object.defineProperty(x,"root",{get:function(){return s[a]}}),s[a]=x;for(var m=0;m<t.length;m++)x(t[m])}({"15EEf":[function(e,t,n,a){var r=e("@parcel/transformer-js/src/esmodule-helpers.js");r.defineInteropFlag(n),r.export(n,"AndroidSMB落地页组件",()=>l);var i=e("@capacitor/core"),o=e("../../../base/base"),d=e("../../../global/tools/create-element"),s=e("./landing-sections");class l extends o.组件基类{static{this.注册组件("android-smb-landing",this)}async 当加载时(){if(!0===i.Capacitor.isNativePlatform())return void window.location.replace("./app.html");this.获得宿主样式().display="block",this.获得宿主样式().minHeight="100dvh",this.shadow.append(this.创建样式(),(0,d.创建元素)("div",{className:"page-shell",children:[(0,d.创建元素)("div",{className:"ambient ambient-one"}),(0,d.创建元素)("div",{className:"ambient ambient-two"}),(0,s.创建头部)([{文本:"核心能力",目标:this.特性区域},{文本:"运行模式",目标:this.模式区域},{文本:"使用方法",目标:this.使用区域}]),(0,d.创建元素)("main",{children:[this.创建英雄区(),(0,s.创建痛点区)(),this.创建特性区(),this.创建模式区(),this.创建使用区(),(0,s.创建行动区)()]}),(0,s.创建页脚)()]}))}创建样式(){return(0,d.创建元素)("style",{textContent:`
        :host {
          --landing-bg: #f7fafc;
      ...
      `})}创建英雄区(){return(0,d.创建元素)("section",{className:"container hero",children:[(0,d.创建元素)("div",{className:"hero-copy",children:[(0,d.创建元素)("div",{className:"eyebrow",children:[(0,d.创建元素)("span",{className:"eyebrow-dot"}),(0,d.创建元素)("span",{textContent:"无需 Root 即可开始"})]}),(0,d.创建元素)("h1",{className:"hero-title",children:["把 Android 手机",(0,d.创建元素)("span",{className:"hero-title-accent",textContent:"变成局域网共享盘"})]}),(0,d.创建元素)("p",{className:"hero-description",textContent:"文件都在手机里，但小屏幕并不适合整理大量目录；找 USB 线很麻烦，WebDAV 面对复杂操作也常常力不从心。Android SMB 让你直接用电脑熟悉的文件管理器处理手机存储。"}),(0,d.创建元素)("div",{className:"hero-actions",children:[(0,d.创建元素)("a",{className:"button button-primary",href:"https://github.com/lsby/android-smb/releases",target:"_blank",rel:"noreferrer",textContent:"下载 Android APK"}),(0,d.创建元素)("a",{className:"button button-secondary",href:"https://github.com/lsby/android-smb",target:"_blank",rel:"noreferrer",textContent:"阅读项目源码"})]}),(0,d.创建元素)("div",{className:"hero-meta",children:[(0,d.创建元素)("span",{textContent:"Android 6.0+"}),(0,d.创建元素)("span",{textContent:"ARM64"}),(0,d.创建元素)("span",{textContent:"SMB2/3"})]})]}),this.创建设备演示()]})}创建设备演示(){let e=(e,t,n)=>(0,d.创建元素)("div",{className:"share-card",children:[(0,d.创建元素)("div",{children:[(0,d.创建元素)("div",{className:"share-name",textContent:e}),(0,d.创建元素)("div",{className:"share-path",textContent:t})]}),(0,d.创建元素)("span",{className:"share-access",textContent:n})]});return(0,d.创建元素)("div",{className:"device-stage",ariaLabel:"Android SMB 运行界面示意图",children:[(0,d.创建元素)("div",{className:"device-orbit"}),(0,d.创建元素)("div",{className:"floating-chip chip-one",textContent:"局域网直连"}),(0,d.创建元素)("div",{className:"floating-chip chip-two",textContent:"前台服务守护"}),(0,d.创建元素)("div",{className:"phone",children:(0,d.创建元素)("div",{className:"phone-screen",children:[(0,d.创建元素)("div",{className:"phone-status",children:[(0,d.创建元素)("span",{textContent:"09:41"}),(0,d.创建元素)("span",{textContent:"LAN 100%"})]}),(0,d.创建元素)("div",{className:"server-label",textContent:"SMB SERVER"}),(0,d.创建元素)("div",{className:"server-state",children:[(0,d.创建元素)("span",{className:"server-state-dot"}),(0,d.创建元素)("span",{textContent:"正在运行"})]}),(0,d.创建元素)("div",{className:"server-address",textContent:"192.168.8.150 : 4450"}),e("internal","/storage/emulated/0","读写"),e("sdcard","/storage/4A12-18F3","读写"),e("system","/","Root 只读"),(0,d.创建元素)("button",{className:"stop-bar",type:"button",textContent:"停止服务器",tabIndex:-1})]})})]})}创建特性区(){return this.特性区域.replaceChildren((0,d.创建元素)("div",{className:"section-inner",children:[(0,d.创建元素)("p",{className:"section-kicker",textContent:"Core capabilities"}),(0,d.创建元素)("h2",{className:"section-title",textContent:"把复杂管理交给电脑，把存储留在手机"}),(0,d.创建元素)("p",{className:"section-description",textContent:"无需把文件先复制出来，也无需适应另一套管理界面。手机负责提供存储，电脑负责高效整理。"}),(0,d.创建元素)("div",{className:"feature-grid",children:[{编号:"01",标题:"普通模式直接使用",描述:"无需修改 iptables、sysctl 或系统 SMB 配置。在 1024–65535 端口运行，默认使用 4450。"},{编号:"02",标题:"多存储根共享",描述:"内部存储和检测到的可移除 SD 卡均可作为独立共享，支持同时挂载和读写。"},{编号:"03",标题:"生命周期可控",描述:"Android 前台服务管理 SMB 子进程。控制进程消失或通信管道断开时，服务器会退出并释放端口。"}].map(e=>(0,d.创建元素)("article",{className:"feature-card",children:[(0,d.创建元素)("div",{className:"feature-number",textContent:e.编号}),(0,d.创建元素)("h3",{textContent:e.标题}),(0,d.创建元素)("p",{textContent:e.描述})]}))})]})),this.特性区域}创建模式区(){return this.模式区域.replaceChildren((0,d.创建元素)("div",{className:"section-inner",children:[(0,d.创建元素)("p",{className:"section-kicker",textContent:"Two modes"}),(0,d.创建元素)("h2",{className:"section-title",textContent:"权限由你决定，Root 从来不是默认项"}),(0,d.创建元素)("p",{className:"section-description",textContent:"应用只会在你主动勾选 Root 模式并点击启动时申请授权。日常使用推荐普通模式。"}),(0,d.创建元素)("div",{className:"mode-grid",children:[(0,s.创建模式卡片)("推荐","普通模式","适合日常在电脑与手机之间传文件。",["端口范围 1024–65535，默认 4450","内部存储与 SD 卡读写共享","不申请 Root 权限"]),(0,s.创建模式卡片)("按需启用","Root 模式","用于必须监听标准端口或读取系统根目录的场景。",["端口范围 1–65535，可使用标准 445","系统根目录固定为只读共享","仅在点击启动时请求 Root 授权"],!0)]})]})),this.模式区域}创建使用区(){return this.使用区域.replaceChildren((0,d.创建元素)("div",{className:"section-inner",children:[(0,d.创建元素)("p",{className:"section-kicker",textContent:"Quick start"}),(0,d.创建元素)("h2",{className:"section-title",textContent:"从安装到挂载，只需要三步"}),(0,d.创建元素)("div",{className:"steps",children:[{编号:"STEP 01",标题:"安装 APK",描述:"从 GitHub Releases 下载并安装适用于 ARM64 Android 设备的安装包。"},{编号:"STEP 02",标题:"授予文件权限",描述:"按应用提示开启“所有文件访问权限”，让普通模式可以访问共享目录。"},{编号:"STEP 03",标题:"启动并映射",描述:"配置并启动服务，在 Windows 中运行应用生成的持久映射命令。"}].map(e=>(0,d.创建元素)("article",{className:"step",children:[(0,d.创建元素)("span",{className:"step-number",textContent:e.编号}),(0,d.创建元素)("h3",{textContent:e.标题}),(0,d.创建元素)("p",{textContent:e.描述})]}))}),(0,d.创建元素)("div",{className:"command-panel",children:[(0,d.创建元素)("div",{children:[(0,d.创建元素)("h3",{textContent:"推荐：固定 IP + 持久映射"}),(0,d.创建元素)("p",{textContent:"首次连接前给手机配置固定 IP。Windows 会保留映射，以后只需打开 Android SMB 并启动服务，手机文件就会重新出现在原来的盘符中。非标准端口需要 Windows 11 24H2 或更新版本。"})]}),(0,d.创建元素)("code",{className:"command",textContent:"net use * \\\\192.168.8.150\\internal /TCPPORT:4450 /user:android-smb * /persistent:yes"})]})]})),this.使用区域}constructor(...e){super(...e),this.特性区域=(0,d.创建元素)("section",{id:"features",className:"section section-soft"}),this.模式区域=(0,d.创建元素)("section",{id:"modes",className:"section"}),this.使用区域=(0,d.创建元素)("section",{id:"guide",className:"section section-soft"})}}},{"@capacitor/core":"gtVFh","../../../base/base":"ksS1x","../../../global/tools/create-element":"6qOji","./landing-sections":"4hJWM","@parcel/transformer-js/src/esmodule-helpers.js":"lMK7c"}],"4hJWM":[function(e,t,n,a){var r=e("@parcel/transformer-js/src/esmodule-helpers.js");r.defineInteropFlag(n),r.export(n,"创建头部",()=>s),r.export(n,"创建痛点区",()=>l),r.export(n,"创建模式卡片",()=>p),r.export(n,"创建行动区",()=>c),r.export(n,"创建页脚",()=>g);var i=e("../../../global/tools/create-element");let o=new URL(e("4a18f744de26f099")).toString(),d=new URL(e("3116f8a7c12d8045")).toString();function s(e){return(0,i.创建元素)("header",{className:"site-header",children:(0,i.创建元素)("div",{className:"container header-inner",children:[(0,i.创建元素)("div",{className:"brand-system",children:[(0,i.创建元素)("a",{className:"studio-brand",href:"https://hbybyyang.cn/",target:"_blank",rel:"noreferrer",ariaLabel:"科达雅软件工作室主页",children:(0,i.创建元素)("img",{className:"studio-logo",src:o,alt:"科达雅软件工作室"})}),(0,i.创建元素)("span",{className:"brand-separator",textContent:"×",ariaHidden:"true"}),(0,i.创建元素)("a",{className:"project-brand",href:"./",ariaLabel:"Android SMB 首页",children:[(0,i.创建元素)("img",{className:"project-logo",src:d,alt:"Android SMB"}),(0,i.创建元素)("span",{className:"project-name",textContent:"Android SMB"})]})]}),(0,i.创建元素)("nav",{className:"nav",ariaLabel:"页面导航",children:e.map(e=>(0,i.创建元素)("button",{type:"button",className:"nav-button",textContent:e.文本,onclick:()=>e.目标.scrollIntoView({behavior:"smooth",block:"start"})}))}),(0,i.创建元素)("a",{className:"github-link",href:"https://github.com/lsby/android-smb",target:"_blank",rel:"noreferrer",textContent:"查看源码"})]})})}function l(){return(0,i.创建元素)("section",{style:{padding:"96px 0",color:"#eef8f8",backgroundColor:"var(--landing-code)"},children:(0,i.创建元素)("div",{style:{width:"min(1160px, calc(100% - 40px))",margin:"0 auto"},children:[(0,i.创建元素)("p",{textContent:"The problem",style:{margin:"0 0 10px",color:"var(--landing-lime)",fontSize:"13px",fontWeight:"800",letterSpacing:"0.1em",textTransform:"uppercase"}}),(0,i.创建元素)("h2",{textContent:"文件在手机里，管理却不该困在手机上",style:{maxWidth:"760px",margin:"0",fontSize:"clamp(32px, 4vw, 46px)",lineHeight:"1.15",letterSpacing:"-0.045em"}}),(0,i.创建元素)("p",{textContent:"过去，为了在手机中整理或传输大量文件，你往往只能在几个都不理想的方案之间反复切换。",style:{maxWidth:"680px",margin:"18px 0 0",color:"#91a9b2",fontSize:"16px",lineHeight:"1.75"}}),(0,i.创建元素)("div",{style:{display:"grid",gridTemplateColumns:"repeat(auto-fit, minmax(220px, 1fr))",gap:"16px",marginTop:"48px"},children:[{编号:"01",标题:"手机不适合复杂整理",描述:"小屏幕和触控操作适合浏览，却不适合批量选择、跨目录移动、重命名和整理大量文件。"},{编号:"02",标题:"应用内操作割裂",描述:"不同应用的文件入口和能力各不相同，路径难找、功能受限，整理工作很容易被打断。"},{编号:"03",标题:"USB 连接成本太高",描述:"临时传个文件还要找线、插线、切换连接模式；接口、驱动和线材状态也可能带来额外问题。"},{编号:"04",标题:"WebDAV 难扛复杂操作",描述:"在部分客户端中，批量移动、重命名、深层目录管理和长时间传输的体验不如原生 SMB 文件共享。"}].map(e=>(0,i.创建元素)("article",{style:{padding:"26px",border:"1px solid rgba(255, 255, 255, 0.09)",borderRadius:"18px",backgroundColor:"rgba(255, 255, 255, 0.045)"},children:[(0,i.创建元素)("span",{textContent:e.编号,style:{color:"var(--landing-lime)",fontFamily:"ui-monospace, SFMono-Regular, Consolas, monospace",fontSize:"12px",fontWeight:"800"}}),(0,i.创建元素)("h3",{textContent:e.标题,style:{margin:"24px 0 10px",fontSize:"19px"}}),(0,i.创建元素)("p",{textContent:e.描述,style:{margin:"0",color:"#91a9b2",fontSize:"14px",lineHeight:"1.75"}})]}))})]})})}function p(e,t,n,a,r=!1){return(0,i.创建元素)("article",{className:r?"mode-card mode-card-highlight":"mode-card",children:[(0,i.创建元素)("span",{className:"mode-tag",textContent:e}),(0,i.创建元素)("h3",{textContent:t}),(0,i.创建元素)("p",{textContent:n}),(0,i.创建元素)("ul",{className:"mode-list",children:a.map(e=>(0,i.创建元素)("li",{textContent:e}))})]})}function c(){return(0,i.创建元素)("section",{className:"cta",children:(0,i.创建元素)("div",{className:"cta-panel",children:[(0,i.创建元素)("h2",{textContent:"在电脑上管理手机文件"}),(0,i.创建元素)("p",{textContent:"开源、局域网直连、Root 可选。现在就把 Android 设备接入你的日常文件工作流。"}),(0,i.创建元素)("a",{className:"button button-primary",href:"https://github.com/lsby/android-smb/releases",target:"_blank",rel:"noreferrer",textContent:"前往 GitHub Releases"})]})})}function g(){return(0,i.创建元素)("footer",{className:"footer",children:(0,i.创建元素)("div",{className:"container footer-inner",children:[(0,i.创建元素)("span",{textContent:"© 2026 科达雅软件工作室 · Android SMB"}),(0,i.创建元素)("div",{className:"footer-links",children:[(0,i.创建元素)("a",{href:"https://hbybyyang.cn/",target:"_blank",rel:"noreferrer",textContent:"工作室主页"}),(0,i.创建元素)("a",{href:"https://beian.miit.gov.cn/",target:"_blank",rel:"noreferrer",textContent:"新ICP备2026003876号-1"}),(0,i.创建元素)("a",{href:"https://beian.mps.gov.cn/#/query/webSearch?code=65010402002238",target:"_blank",rel:"noreferrer",textContent:"新公网安备65010402002238号"})]})]})})}},{"../../../global/tools/create-element":"6qOji","4a18f744de26f099":"etc8x","3116f8a7c12d8045":"hQ3u0","@parcel/transformer-js/src/esmodule-helpers.js":"lMK7c"}],etc8x:[function(e,t,n,a){t.exports=import.meta.resolve("d3dJL")},{}],hQ3u0:[function(e,t,n,a){t.exports=import.meta.resolve("ke3An")},{}]},[],0,"parcelRequire2a1f",{});