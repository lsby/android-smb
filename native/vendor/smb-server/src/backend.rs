...
/// Allocation information reported to SMB clients for a share's backing
/// filesystem.
#[derive(Debug, Clone, Copy)]
...
pub trait ShareBackend: Send + Sync + 'static {
    ...
    /// Capacity information for the filesystem backing this share. Backends
    /// that cannot provide it may return `None`.
